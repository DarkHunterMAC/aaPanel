...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://github.com/DarkHunterMAC/aapanel/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://raw.githubusercontent.com/DarkHunterMAC/aapanel/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://github.com/DarkHunterMAC/aaPanel/releases/download/1.3/LinuxPanel-7.7.0.zip"
...
wget https://raw.githubusercontent.com/DarkHunterMAC/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
...
wget -O /root/chinese.zip https://github.com/DarkHunterMAC/aaPanel/releases/download/1.2/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/DarkHunterMAC/aaPanel"
    yellow " ————————————————————————————————————————————————"
